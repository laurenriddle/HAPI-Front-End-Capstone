                ...
                <div className="listCard card">
                    <Card>
                        <div className="card-contentnext">
                            <Card.Body>
                                <h2><span className="card-erdname">{this.props.result.API}<Button onClick={() => {this.props.history.push(`/apisearch/${this.props.result.API}/save`) }}>Save</Button></span></h2><hr />
